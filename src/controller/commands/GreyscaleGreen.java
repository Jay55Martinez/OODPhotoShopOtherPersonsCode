...
/**
 * Class represents a command to apply greyscale Green channel  transformation to an image.
 ...
 * given filename with the "option" being the GreyscaleGreen class, and so it will delegate
 * the pixel editing to the model.transform.GreyscaleGreen class and add it to the model
 * map as the newName.
 * </p>
 */
public class GreyscaleGreen implements ImageCommands {
  ...
  /**
   * Instantiate the Greyscale Green object with a filename and newName. The filename
   ...
   */
  public GreyscaleGreen(String filename, String newName) {
  ...
  public void edit(ImageModel model) {
    model.transform(filename, newName, new model.transform.GreyscaleGreen());
    System.out.println(this.toString());
  }

  @Override
  public String toString() {
    return "Green Channel Greyscale";
  }
